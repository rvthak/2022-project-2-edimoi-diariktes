...
a = 5007965719154398295316829646509289701874861709891808846734792385015541826201
b = 20129353592886270223448727591627806607524309415930743719526720763604786378070
c = 45364163628598845685938428155401936384627058279694842643445501229807995000756

x = [1, 2, 3]
y = [a, b, c]

result = interpolate_polynomial(x,y)
print(result)
